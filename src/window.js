...
export class Window extends Adw.ApplicationWindow {
  ...
  constructor(application) {
    ...
    const display_timer_component = display_timer({ application });
    this._menu_button.get_popover().add_child(theme_selector, 'theme');
    this.set_help_overlay(new Shortcuts(application));
    this._timer_page.set_child(timer({ application, display_timer: display_timer_component }));
    ...
    this._small_window = new SmallWindow({ application, display_timer_component });
